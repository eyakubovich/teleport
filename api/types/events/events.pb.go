...
func (SessionNetwork_NetworkOperation) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_8f22242cb04491f9, []int{17, 0}
}

// RestrictionStatus communicates whether the event was allowed or denied (blocked).
type SessionNetwork_RestrictionStatus int32

const (
	SessionNetwork_ALLOWED SessionNetwork_RestrictionStatus = 0
	SessionNetwork_DENIED  SessionNetwork_RestrictionStatus = 1
)

var SessionNetwork_RestrictionStatus_name = map[int32]string{
	0: "ALLOWED",
	1: "DENIED",
}

var SessionNetwork_RestrictionStatus_value = map[string]int32{
	"ALLOWED": 0,
	"DENIED":  1,
}

func (x SessionNetwork_RestrictionStatus) String() string {
	return proto.EnumName(SessionNetwork_RestrictionStatus_name, int32(x))
}

func (SessionNetwork_RestrictionStatus) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_8f22242cb04491f9, []int{17, 1}
}
...
type SessionNetwork struct {
	...
	// Restriction denotes if the operation was allowed or denied
	Restriction          SessionNetwork_RestrictionStatus `protobuf:"varint,11,opt,name=Restriction,proto3,enum=events.SessionNetwork_RestrictionStatus" json:"restriction"`
	XXX_NoUnkeyedLiteral struct{}                         `json:"-"`
	XXX_unrecognized     []byte                           `json:"-"`
	XXX_sizecache        int32                            `json:"-"`
}
...
func init() {
	...
	proto.RegisterEnum("events.SessionNetwork_RestrictionStatus", SessionNetwork_RestrictionStatus_name, SessionNetwork_RestrictionStatus_value)
...
var fileDescriptor_8f22242cb04491f9 = []byte{
	...
	,
}
...
func (m *SessionNetwork) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.Restriction != 0 {
		i = encodeVarintEvents(dAtA, i, uint64(m.Restriction))
		i--
		dAtA[i] = 0x58
	}
	if m.Operation != 0 {
...
func (m *StreamStatus) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	n240, err240 := github_com_gogo_protobuf_types.StdTimeMarshalTo(m.LastUploadTime, dAtA[i-github_com_gogo_protobuf_types.SizeOfStdTime(m.LastUploadTime):])
	if err240 != nil {
		return 0, err240
	}
	i -= n240
	i = encodeVarintEvents(dAtA, i, uint64(n240))
	i--
	dAtA[i] = 0x1a
...
func (m *SessionNetwork) Size() (n int) {
	...
	if m.Restriction != 0 {
		n += 1 + sovEvents(uint64(m.Restriction))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
	...
	for iNdEx < l {
		...
		case 11:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Restriction |= SessionNetwork_RestrictionStatus(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
